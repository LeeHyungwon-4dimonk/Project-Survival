...
public class TableBoxSetUpATableToSO : MonoBehaviour
{
    ...
    public static void GenerateBoxSetUpA()
    {
        ...
        foreach (BoxSetUpData s in boxSetUpA)
        {
            ...
            boxSetUp.BoxSetUpA.Add(new BoxSetup { ItemName = boxSetUpName, ProbType1 = 0.01f * ProbType1, ProbType2 = 0.01f * ProbType2, ProbType3 = 0.01f * ProbType3, ItemCount = Count });
        }
