...
public class TableBoxProbToSO : MonoBehaviour
{
    ...
    public static void GenerateBoxProb()
    {
        ...
        foreach (BoxProbData s in boxProbs)
        {
            ...
            boxProb.BoxProbs.Add(new BoxProb { DayNum = boxProb_DayNum, BoxType1Prob = 0.01f * boxProb_BoxType1, BoxType2Prob = 0.01f * boxProb_BoxType2, BoxType3Prob = 0.01f * boxProb_BoxType3 });
        }
